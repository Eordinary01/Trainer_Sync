...
export function PendingLeaves() {
 ...
 const handleApprove = async (leaveId) => {
  try {
    // Send both comments and remarks for backward compatibility
    await api.put(`/leaves/${leaveId}/approve`, { 
      comments: remarks,
      remarks: remarks // Send both for compatibility
    });
    ...
    <div className="max-w-6xl mx-auto">
      ...
      {leaves.length === 0 ? (
        ...
        <div className="space-y-4">
          {leaves.map((leave) => (
            <div key={leave._id} className="bg-white rounded-lg shadow-md p-6 border-l-4 border-yellow-500">
