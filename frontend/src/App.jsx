...
import { PendingLeaves, ApprovedLeaves, LeaveReports } from "./components/Admin/LeavePage.jsx";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/login"
          element={isAuthenticated ? <Navigate to={getDefaultRoute()} replace /> : <LoginForm />}
        />
              ...
              <div className="min-h-screen bg-gray-50">
                ...
                <div className="container mx-auto px-4 py-6">
                  <Routes>
                    ...
                    <Route path="trainers/create" element={<CreateTrainerForm />} />
                    <Route path="trainers" element={<TrainersList />} />
                    <Route path="attendance" element={<AttendanceReport />} />
                    <Route path="clocked-in" element={<ClockedInNow />} /> 
                    <Route path="leaves/pending" element={<PendingLeaves />} />
                    <Route path="leaves/approved" element={<ApprovedLeaves />} />
                    <Route path="leaves/reports" element={<LeaveReports />} />
                    <Route path="hr/create" element={<CreateAdminForm />} />
                    <Route path ="/trainers/:trainerId" element={<TrainerDetailedView/>}/>
                    <Route path="profile" element={<ProfilePage />} />
                    <Route path="trainers/:id/profile" element={<ProfilePage />} />
                  </Routes>
                </div>
              </div>
            </ProtectedRoute>
